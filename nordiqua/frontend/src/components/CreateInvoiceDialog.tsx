{/* Même contenu que précédemment, mais avec la correction de la ligne problématique */}
    ...
    <Dialog.Root open={open} onOpenChange={setOpen}>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed left-[50%] top-[50%] max-h-[85vh] w-[95vw] max-w-[1200px] translate-x-[-50%] translate-y-[-50%] overflow-y-auto rounded-lg bg-white p-4 md:p-6 shadow-lg z-50">
          <Dialog.Title className="text-xl font-semibold">Créer une nouvelle facture</Dialog.Title>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <div className="flex items-center justify-between">
                    ...
                    <Button type="button" onClick={addItem} variant="outline" className="rounded-lg">
                ...
                <div className="bg-white rounded-lg shadow-lg p-8">
                  ...
                  <div className="mt-6 grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <div className="mt-1 font-medium">
                        {new Date(new Date(invoiceDate).setDate(new Date(invoiceDate).getDate() + 30)).toLocaleDateString('fr-FR')}
                      </div>
                    </div>
                  </div>
                    ...
                    <table className="w-full">
                      <thead>
                        <tr className="border-b border-gray-200">
                          ...
                          <th className="py-2 text-right text-sm font-semibold text-gray-600">QTÉ</th>
                          <th className="py-2 text-right text-sm font-semibold text-gray-600">PRIX</th>
                        ...
                        {items.map((item, index) => (
                          <tr key={index}>
                            <td className="py-3 text-sm">
                              {item.description || <span className="text-gray-400 italic">Description de l'article</span>}
                            </td>
                  ...
                  <div className="mt-6 border-t border-gray-200 pt-6">
                    ...
                    <div className="mt-2 flex justify-between">
                      ...
                      <div className="font-medium">
                        {tva.toLocaleString('fr-FR', { style: 'currency', currency: 'EUR' })}
                      </div>
                    </div>
