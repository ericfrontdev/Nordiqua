    ...
    <Dialog.Root open={open} onOpenChange={setOpen}>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed left-[50%] top-[50%] max-h-[85vh] w-[95vw] max-w-[600px] translate-x-[-50%] translate-y-[-50%] overflow-y-auto rounded-lg bg-white p-4 md:p-6 shadow-lg z-50">
          <Dialog.Title className="text-xl font-semibold">Ajouter un nouveau produit</Dialog.Title>
          <Dialog.Description className="mt-2 text-sm text-gray-500">
            Remplissez les informations ci-dessous pour créer un nouveau produit ou service.
          </Dialog.Description>
